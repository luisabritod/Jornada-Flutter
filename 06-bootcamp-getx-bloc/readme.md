# 🚀 Bootcamp de Gerenciamento de Estado: GetX e BLoC

Este módulo representa uma imersão intensiva nas duas arquiteturas de gerenciamento de estado mais populares e demandadas do mercado Flutter, além do Provider.

O objetivo foi construir os mesmos aplicativos usando abordagens diferentes para entender na prática as vantagens, desvantagens e casos de uso de cada uma.
